											...
											<div class="wall-comment-list">
												<div class="pmo-block pmo-contact" style="font-size: 14px;">
													...
													<ul>
														...
														<li class="p-b-5"><i class="zmdi zmdi-skype" data-toggle="tooltip" data-placement="top" title="" data-original-title="Skype"></i> {if !empty($ban.admin_skype)}{$ban.admin_skype}{else}Нет данных...{/if}</li>
														<li class="p-b-5">
