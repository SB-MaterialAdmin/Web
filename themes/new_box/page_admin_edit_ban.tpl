		...
		<div class="form-horizontal" role="form" id="add-group">
			...
			<div class="card-body card-padding p-b-0" id="group.details">
				<div class="form-group m-b-5">
					<label for="name" class="col-sm-3 control-label">-{help_icon title="Имя игрока" message="Имя забаненного игрока."}- Имя игрока</label>
					<div class="col-sm-9">
						<div class="fg-line">
							<input type="text" TABINDEX=1 class="form-control" id="name" name="name" value="-{$ban_name}-" placeholder="Введите данные">
						</div>
						<div id="name.msg"></div>
					</div>
				</div>
				<div class="form-group m-b-5">
					<label for="type" class="col-sm-3 control-label">-{help_icon title="Тип бана" message="Как банить: по STEAM ID или по IP."}- Тип бана</label>
					<div class="col-sm-2">
				...
				<div class="form-group m-b-5">
					<label for="steam" class="col-sm-3 control-label">-{help_icon title="Steam ID" message="Steam ID забаненного игрока. Также можно ввести его Community ID."}- Steam ID / Community ID</label>
					<div class="col-sm-9">
						<div class="fg-line">
							<input type="text" TABINDEX=1 class="form-control" id="steam" name="steam" value="-{$ban_authid}-" placeholder="Введите данные">
						</div>
						<div id="steam.msg"></div>
					</div>
				</div>
				<div class="form-group m-b-5">
					<label for="ip" class="col-sm-3 control-label">-{help_icon title="IP адрес" message="IP адрес забаненного игрока"}- IP адрес</label>
					<div class="col-sm-9">
						<div class="fg-line">
							<input type="text" TABINDEX=1 class="form-control" id="ip" name="ip" value="-{$ban_ip}-" placeholder="Введите данные">
						</div>
						<div id="ip.msg"></div>
					</div>
				</div>
				...
				<div class="form-group m-b-5">
					<label for="banlength" class="col-sm-3 control-label">-{help_icon title="Срок бана" message="Выберите срок бана."}- Срок бана</label>
					<div class="col-sm-3">
			...
			<div class="card-body card-padding text-center">
				...
				-{sb_button text="Сохранить" icon="<i class='zmdi zmdi-check-all'></i>" class="bgm-green btn-icon-text" id="editban" submit=true}-
			    &nbsp;
