{if !$permission_addadmin}
    Доступ запрещен!
{else}
    {if $overrides_error}
        <script type="text/javascript">ShowBox("Ошибка", "{$overrides_error|escape:'javascript'}", "red");</script>
    {/if}
                        ...
                        {foreach $overrides_list as $override}
                            <tr>
                                <td class="text-left">
                                    ...
                                    <input type="hidden" name="override_id[]" value="{$override.id|escape:'htmlall'}" />
                                </td>
                                <td>
                                    <div class="form-group m-b-5">
                                        <div class="col-sm-9">
                                            <div class="fg-line">
                                                <input type="text" class="form-control" name="override_name[]" value="{$override.name|escape:'htmlall'}">
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                   <div class="form-group m-b-5">
                                        <div class="col-sm-9">
                                            <div class="fg-line">
                                                <input type="text" class="form-control" name="override_flags[]" value="{$override.flags|escape:'htmlall'}">
                                            </div>
                                        </div>
                                   </div>
                                </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group m-b-5">
                                    <div class="col-sm-9">
                                        <div class="fg-line">
                                            <input type="text" class="form-control" id="new_override_name" name="new_override_name" placeholder="Введите данные(обязательное поле)">
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="form-group m-b-5">
                                    <div class="col-sm-9">
                                        <div class="fg-line">
                                            <input type="text" class="form-control" id="new_override_flags" name="new_override_flags" placeholder="Введите данные(обязательное поле)">
                                        </div>
                                    </div>
                                </div>
                            </td>
