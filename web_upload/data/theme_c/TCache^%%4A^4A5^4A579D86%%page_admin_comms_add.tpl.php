<?php /* Smarty version 2.6.29, created on 2018-09-19 08:36:27
         compiled from page_admin_comms_add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'help_icon', 'page_admin_comms_add.tpl', 13, false),array('function', 'sb_button', 'page_admin_comms_add.tpl', 117, false),)), $this); ?>
...
<div class="card">
	<div class="form-horizontal" role="form" id="add-group1">
		...
		<div class="card-body card-padding p-b-0" id="group.details">
			<div class="form-group m-b-5">
				<label for="nickname" class="col-sm-3 control-label"><?php echo smarty_function_help_icon(array('title' => "Ник",'message' => "Введите ник игрока, которому дать блокировку."), $this);?>
 Ник</label>
				<div class="col-sm-9">
					<div class="fg-line">
			...
			<div class="form-group m-b-5">
				<label for="steam" class="col-sm-3 control-label"><?php echo smarty_function_help_icon(array('title' => "Steam ID / Community ID",'message' => "Steam ID или Community ID игрока, которому дать блокировку."), $this);?>
 Steam ID / Community ID</label>
			...
			<div class="form-group m-b-5">
				<label for="type" class="col-sm-3 control-label"><?php echo smarty_function_help_icon(array('title' => "Тип блокировки",'message' => "Выберите что блокировать-чат или микрофон"), $this);?>
Тип блокировки </label>
				<div class="col-sm-2">
			...
			<div class="form-group m-b-5">
				<label for="listReason" class="col-sm-3 control-label"><?php echo smarty_function_help_icon(array('title' => "Причина блокировки",'message' => "Выберите причину, по которой хотите произвести блокировку."), $this);?>
 Причина блокировки</label>
			...
			<div class="form-group m-b-5">
				<label for="banlength" class="col-sm-3 control-label"><?php echo smarty_function_help_icon(array('title' => "Срок блокировки",'message' => "Выберите, на какой срок Вы хотите его заблокировать."), $this);?>
 Срок блока</label>
				<div class="col-sm-3">
		...
		<div class="card-body card-padding text-center">
			<?php echo smarty_function_sb_button(array('text' => "Добавить блокировку",'onclick' => "ConvertSteamID_3to2('steam');ProcessBan();",'icon' => "<i class='zmdi zmdi-shield-security'></i>",'class' => "bgm-green btn-icon-text",'id' => 'aban','submit' => false), $this);?>
