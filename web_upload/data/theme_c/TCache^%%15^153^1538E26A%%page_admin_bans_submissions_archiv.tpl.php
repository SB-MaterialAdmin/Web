...
<?php if (! $this->_tpl_vars['permissions_submissions']): ?>
	Доступ запрещен!
<?php else: ?>
	<h3 style="margin-top:0px;">Архив заявок на бан (<span id="subcountarchiv"><?php echo $this->_tpl_vars['submission_count_archiv']; ?>
</span>)</h3>
						...
						<table width="90%" cellspacing="0" cellpadding="0" class="listtable">
							...
							<tr align="left">
									<td height="16" align="left" class="listtable_1" colspan="2">
										<b>В архиве по причине <?php echo $this->_tpl_vars['sub']['archive']; ?>
</b>
									</td>
