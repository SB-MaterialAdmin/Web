<?php /* Smarty version 2.6.29, created on 2018-09-25 12:55:23
         compiled from page_error.tpl */ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <title>SourceBans :: <?php echo $this->_tpl_vars['title']; ?>
</title>
            ...
            <section id="content">
                ...
                <div class="card login-content go-social">
                    ...
                    <div class="card-body card-padding">
                        ...
                        <pre><?php echo $this->_tpl_vars['pfunction']; ?>
</pre>
                    </div>
                </div>
            </section>
