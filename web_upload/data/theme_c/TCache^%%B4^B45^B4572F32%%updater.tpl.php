<?php /* Smarty version 2.6.29, created on 2018-09-18 17:03:55
            ...
            <section id="content">
                ...
                <div class="card login-content go-social">
                    ...
                    <div class="card-body card-padding">
                        <p><?php echo $this->_tpl_vars['setup']; ?>
</p>
                        <?php if ($this->_tpl_vars['progress']): ?><br /><p><?php echo $this->_tpl_vars['progress']; ?>
</p><?php endif; ?>
                    </div>
                </div>
            </section>
