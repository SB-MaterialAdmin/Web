<?php /* Smarty version 2.6.29, created on 2018-09-23 13:43:32
         compiled from box_admin_bans_search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sb_button', 'box_admin_bans_search.tpl', 309, false),)), $this); ?>
<div class="row">
	<div class="col-sm-2">
	</div>
	<div class="col-sm-8">
					...
					<tbody>
						...
						<?php if (! $this->_tpl_vars['hideplayerips']): ?>
							<tr>
								...
								<td class="p-b-5">
									<div class="p-t-5"><label for="ip" onclick="$('ip_').checked = true">IP адрес</label></div>
								</td>
								<td class="p-b-5">
									<div class="fg-line">
										<input type="text" class="form-control" id="ip" value="" onmouseup="$('ip_').checked = true" placeholder="Введите IP адрес" />
									</div>
								</td>
							</tr>
						<?php endif; ?>
...
">  Получение адреса... (<?php echo $this->_tpl_vars['server']['ip']; ?>
:<?php echo $this->_tpl_vars['server']['port']; ?>
			...
			<div class="card-body p-b-20 text-center">
				<?php echo smarty_function_sb_button(array('text' => "Поиск",'onclick' => "search_bans();",'icon' => "<i class='zmdi zmdi-search'></i>",'class' => "bgm-green btn-icon-text",'id' => 'searchbtn','submit' => false), $this);?>
