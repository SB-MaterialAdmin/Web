...
smarty_core_load_plugins(array('plugins' => array(array('function', 'help_icon', 'page_admin_bans_add.tpl', 13, false),array('function', 'sb_button', 'page_admin_bans_add.tpl', 149, false),)), $this); ?>
...
<div class="card">
	<div class="form-horizontal" role="form" id="add-group1">
		...
		<div class="card-body card-padding p-b-0" id="group.details">
			<div class="form-group m-b-5">
				<label for="nickname" class="col-sm-3 control-label"><?php echo smarty_function_help_icon(array('title' => "Ник",'message' => "Введите ник игрока, которого желаете забанить."), $this);?>
 Ник</label>
				<div class="col-sm-9">
					<div class="fg-line">
			...
			<div class="form-group m-b-5">
				<label for="type" class="col-sm-3 control-label"><?php echo smarty_function_help_icon(array('title' => "Тип бана",'message' => "Как банить, по Steam ID или по IP адресу?."), $this);?>
 Тип бана</label>
				<div class="col-sm-2">
			...
			<div class="form-group m-b-5">
				<label for="steam" class="col-sm-3 control-label"><?php echo smarty_function_help_icon(array('title' => "Steam ID / Community ID",'message' => "Steam ID или Community ID игрока, которого желаете забанить."), $this);?>
 Steam ID / Community ID</label>
			...
			<div class="form-group m-b-5">
				<label for="ip" class="col-sm-3 control-label"><?php echo smarty_function_help_icon(array('title' => "IP адрес",'message' => "Введите IP адрес игрока, которого желаете забанить."), $this);?>
 IP адрес</label>
				<div class="col-sm-9">
					<div class="fg-line">
...
"><?php echo $this->_tpl_vars['creason']; ?>
			...
			<div class="form-group m-b-5">
				<label for="banlength" class="col-sm-3 control-label"><?php echo smarty_function_help_icon(array('title' => "Срок бана",'message' => "Выберите, на какой срок Вы хотите его забанить."), $this);?>
 Срок бана</label>
				<div class="col-sm-3">
 ...
 Загрузить демо</label>
		...
		<div class="card-body card-padding text-center">
			<?php echo smarty_function_sb_button(array('text' => "Добавить бан",'onclick' => "ConvertSteamID_3to2('steam');ProcessBan();",'icon' => "<i class='zmdi zmdi-shield-security'></i>",'class' => "bgm-green btn-icon-text",'id' => 'aban','submit' => false), $this);?>
