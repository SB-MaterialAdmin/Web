...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sb_button', 'box_admin_log_search.tpl', 126, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['admin']['user']; ?>
				...
				<div class="card-body p-b-20 text-center">
					<?php echo smarty_function_sb_button(array('text' => "Поиск",'onclick' => "search_log();",'icon' => "<i class='zmdi zmdi-search'></i>",'class' => "bgm-green btn-icon-text",'id' => 'searchbtn','submit' => false), $this);?>
