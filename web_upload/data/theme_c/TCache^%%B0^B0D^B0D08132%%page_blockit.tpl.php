<?php /* Smarty version 2.6.29, created on 2018-09-19 08:38:37
...
function set_counter(count)
{
 ...
 || count=='-1') {
		parent.document.getElementById('dialog-control').innerHTML = "<font color=\"green\" style=\"font-size: 12px;\"><b>Успешный поиск.</b></font>"+parent.document.getElementById('dialog-control').innerHTML;
...
<h3 style="font-size: 12px;">Поиск игрока на серверах...</h3>
<table border="0">
...
"><font size="1">Подождите...</font></div>
	</td>
</tr>
