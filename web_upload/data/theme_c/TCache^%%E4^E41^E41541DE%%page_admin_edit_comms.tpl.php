<?php /* Smarty version 2.6.29, created on 2018-09-19 08:29:21
			...
			<table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
			  <tr>
			    <td valign="top" width="35%">
				  <div class="rowdesc">
				    <?php echo smarty_function_help_icon(array('title' => "Ник",'message' => "Ник заблокированного игрока."), $this);?>
Ник
				  </div>
				</td>
			    <td>
...
" />
			  ...
			  <tr>
    			<td valign="top">
    			  <div class="rowdesc">
    				<?php echo smarty_function_help_icon(array('title' => 'Steam ID','message' => "Steam ID игрока. Можно использовать Community ID."), $this);?>
Steam ID
    			  </div>
    			</td>
    		 	<td>
...
" type="text" TABINDEX=2 class="submit-fields" id="steam" name="steam" />
    		...
    		<td valign="top" width="35%">
    			<div class="rowdesc">
    				<?php echo smarty_function_help_icon(array('title' => "Тип блокировки",'message' => "Выберите тип блокировки- чат или микрофон"), $this);?>
Тип блокировки
    			</div>
    		</td>
    		<td>
 		  ...
 		  <tr>
    		<td valign="top" width="35%">
    			<div class="rowdesc">
    				<?php echo smarty_function_help_icon(array('title' => "Причина блокировки",'message' => "Объясните подробно, почему дается блокировка."), $this);?>
Причина блокировки
    			</div>
    		</td>
    		<td>
      ...
      <tr>
			    <td valign="top" width="35%"><div class="rowdesc"><?php echo smarty_function_help_icon(array('title' => "Срок",'message' => "Выберите на сколько выдавать блокировку."), $this);?>
Срок блокировки</div></td>
			    <td><div align="left">
			  ...
			  <tr>
			    ...
			    <td>
			      ...
			      <input type="hidden" name="dname" id="dname" value="" />
			      	<?php echo smarty_function_sb_button(array('text' => "Сохранить",'class' => 'ok','id' => 'editban','submit' => true), $this);?>

			     	 &nbsp;
			     	 <?php echo smarty_function_sb_button(array('text' => "Назад",'onclick' => "history.go(-1)",'class' => 'cancel','id' => 'back','submit' => false), $this);?>
