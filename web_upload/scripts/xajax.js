            ...
            case xajaxDefinedGet:
                {
                    ...
                    uriGet += "&xajaxr=" + new Date().getTime();uri += uriGet;postData = null;
                }
                break;
            case xajaxDefinedPost:
                {
                    postData = "xajax=" + encodeURIComponent(sFunction);postData += "&xajaxr=" + new Date().getTime();
                    if (aArgs) {
                        for (i = 0; i < aArgs.length; i++) {
                            value = aArgs[i];
                            if (typeof(value) == "object")
        ...
        r.onreadystatechange = function() {
            ...
            if (r.status == 200) {
                ...
                /*else if (r.responseText) {
                    ...
                    ShowBox('AJAX Call Failed!', errorString, 'red', '', true);
