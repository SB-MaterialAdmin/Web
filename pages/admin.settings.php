...
if(!defined("IN_SB")){echo "Ошибка доступа!";die();}
	...
	if(isset($_GET['advSearch']))
	{
        ...
        // Ну и говнище же, пиздец, смотришь на это и хочется плакать, inzanty (c) 18.06.2021
        $value = substr(filter_var($GLOBALS['db']->qstr($_GET['advSearch'], FILTER_SANITIZE_ADD_SLASHES)), 1, -1);
		$type = $_GET['advType'];
		switch($type)
		{
			case "admin":
